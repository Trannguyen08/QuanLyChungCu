...
import controller.ManagerControl.ContractControl.mainHandler;
...
public class ContractUI extends javax.swing.JPanel {
    ...
    public ContractUI() {
        initComponents();
        new mainHandler(contractType, deleteBtn, excelBtn, pdfBtn, searchButton, searchIcon, searchField, table, this);
    }
    ...
    private void initComponents() {
        ...
        pdfBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pdf.png"))); // NOI18N
        ...
        jLabel2.setText("Chọn loại hợp đồng:");

        contractType.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
        contractType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Cho thuê", "Mua bán" }));
