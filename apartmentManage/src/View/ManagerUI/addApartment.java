...
import Controller.ManagerControl.ApartmentHandle.addButtonHandler;
...
public class addApartment extends javax.swing.JFrame {
    public addApartment(JTable table) {
        initComponents();
        addButtonHandler add = new addButtonHandler(addBtn, ownerID, apartmentIndex, area, building, buyPrice, floor,
