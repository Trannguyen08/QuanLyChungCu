...
public class Contract extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_HợpĐồng", "ID_CănHộ", "ID_Cư Dân", "Người Tạo", "Kiểu Hợp Đồng", "Ngày Bắt Đầu", "Ngày Kết Thúc", "Giá Mua", "TT Thanh Toán", "TT Hợp Đồng"
            }
        ));
    ...
    ImageIcon icon = new ImageIcon(getClass().getResource("/images/pdf.png"));

    // Chỉnh kích thước ảnh
    Image img = icon.getImage().getScaledInstance(10, 10, Image.SCALE_SMOOTH);
    ImageIcon scaledIcon = new ImageIcon(img);

    // Gán ảnh mới vào jButton8
