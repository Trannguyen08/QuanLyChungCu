...
import utc2.apartmentManage.controller.user.infomation.editInfoHandle;

import javax.swing.*;

public class editResidentInfo extends JFrame {

    public editResidentInfo(int infoID, JLabel mailLabel, JLabel phoneLabel, JLabel idcardLabel) {
        initComponents();
        editInfoHandle editResidentInfoHandle = new editInfoHandle(infoID, mailLabel, phoneLabel,
