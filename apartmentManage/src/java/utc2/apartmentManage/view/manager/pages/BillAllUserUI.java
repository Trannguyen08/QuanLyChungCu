...
public class BillAllUserUI extends JPanel {
    ...
    public BillAllUserUI(JPanel main) {
        initComponents();
        new billAllUserHandle(notiBtn, backBtn, excelBtn, printBtn, month, year, status, searchField, table, main);
    ...
    private void initComponents() {
        ...
        notiBtn.setBackground(new java.awt.Color(13, 50, 107));
        notiBtn.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        notiBtn.setForeground(new java.awt.Color(255, 255, 255));
        notiBtn.setText("Thông báo thanh toán");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(notiBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(25, 25, 25))
        );
