...
import javax.swing.*;
import main.java.utc2.apartmentManage.controller.ManagerControl.ContractControl.searchIconHandler;
...
public class searchContract extends JFrame {
    ...
    public searchContract(JTable table) {
        ...
        searchIconHandler handler = new searchIconHandler(ownerName, contractType, fromValue, toValue, 
