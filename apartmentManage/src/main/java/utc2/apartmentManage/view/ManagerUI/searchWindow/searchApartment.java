...
import javax.swing.*;
import main.java.utc2.apartmentManage.controller.ManagerControl.ApartmentHandle.searchIconHandler;

public class searchApartment extends JFrame {
    public searchApartment(JTable table) {
        initComponents();
        searchIconHandler search = new searchIconHandler(building, this, fromArea, interior,
    ...
    private void initComponents() {
        ...
        status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Đã thuê", "Đã bán", "Trống", "Bảo trì" }));
        ...
        interior.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Đầy đủ", "Cơ bản", "Trống" }));
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(toArea, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
